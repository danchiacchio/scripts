...
def main_menu():
    while True:
        print()
        print("-"*60)
        print("📝 ESXi DNS Manager")
        print("-"*60)
        print("1. Check DNS config on ESXi hosts")
        print("2. Change DNS Servers on ESXi hosts")
        print("3. Change DNS Domain on ESXi hosts")
        print("4. Flush DNS Cache on ESXi hosts")
        print("5. Run a command on ESXi hosts")
        print("6. Get all clusters in the vCenter Server")
        print("7. Get all ESXi hosts in a Cluster")
        print("0. Exit")
        choice = input("Enter your choice: ")

        if choice == "1":
            show_dns_config_for_cluster()
        elif choice == "2":
            change_dns_server()
        elif choice == "3":
            change_dns_domain()
